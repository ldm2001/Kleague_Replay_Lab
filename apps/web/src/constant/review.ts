...
export const reviewFields = [
  { name: "contact", label: "선수 사이 접촉", group: "영상 사실", options: [["null", "미확인"], ["true", "접촉 확인"], ["false", "접촉 없음 확인"]] },
  ...
  { name: "penalty", label: "페널티 구역 안 접촉", group: "영상 사실", options: [["null", "미확인"], ["true", "구역 안 확인"], ["false", "구역 밖 확인"]] },
  ...
  { name: "restart", label: "경기 재개 여부", group: "VAR 조건", options: [["null", "미확인"], ["true", "이미 재개"], ["false", "재개 전 확인"]] },
  ...
  { name: "identity", label: "카드 대상 선수 착오", group: "VAR 조건", options: [["null", "미확인"], ["false", "착오 없음 확인"], ["true", "착오 확인"]] },
  ...
  { name: "missed", label: "심각한 사건의 누락", group: "VAR 조건", options: [["null", "미확인"], ["false", "누락 없음 확인"], ["true", "누락 확인"]] },
...
export const reviewFacts = (values: Record<string, string>, shots: string[]): EvaluationFacts | null => {
  ...
  return {
    push: {
      contactDetected: { value: values.contact === "null" ? null : values.contact === "true", observedAtSpeed, shotIds: shots },
      ...
      insidePenaltyArea: { value: values.penalty === "null" ? null : values.penalty === "true", observedAtSpeed, shotIds: shots },

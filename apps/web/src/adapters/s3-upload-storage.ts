...
import type { CompleteUploadStorage, CreateUploadStorage, EvidenceBody, EvidenceBodyStorage, EvidenceGrant, EvidenceGrantInput, EvidenceStorage, JobSourceStorage, UploadGrant, UploadedObjectHead } from "@replay/application";
...
// S3 저장소 어댑터
export class S3Storage implements CreateUploadStorage, CompleteUploadStorage, JobSourceStorage, EvidenceStorage, EvidenceBodyStorage {

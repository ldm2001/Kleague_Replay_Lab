...
export type {
    ...
    CompletionInput,
    CompletionResult
} from "./use-cases/upload/completion";
// 업로드 생성 유스케이스 공개
...
// 사실과 규정을 대조하는 평가 기능 외부 공개
export type {
    AssessmentDependencies,
    AssessmentInput,
    AssessmentResult
} from "./use-cases/evaluation/assessment";
// 사실 수정 유스케이스 공개
...
export type {
    ...
    DecisionInput,
    DecisionResult
} from "./use-cases/evaluation/decision";
// 사실과 규정을 대조하는 평가 기능 외부 공개
export type {
    DecisionSaveCommand,
    DecisionSaveResult,
...
export type {
    ...
    EvidenceStore
} from "./ports/repositories/evidence-store";
// 증거 업로드 유스케이스 공개
export type {
    EvidenceBody,
    EvidenceBodyStorage,
...
} from "./ports/storage/evidence-storage";
// 증거 권한 유스케이스 공개

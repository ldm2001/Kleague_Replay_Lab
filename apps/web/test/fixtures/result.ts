...
// 판정 시험 입력으로 사실 개정번호 식별자 77777777 7777 4777 8777 777777777777 및 사실 및 원본 지정 문자열 및 판정 파울 자료 생성
...
export const candidate = (index: number, value: JudgmentView | null = null): CandidateView => ({
    ...
    signalScore: 0.41 + index / 100,
    cameraSufficiency: "MEDIUM",
    reasons: ["motion_spike"],
    evidence: [
        {
            evidenceId: `${String(index + 1).padStart(8, "0")}-2222-4222-8222-222222222222`,
            kind: "FRAME"
        },
        {
            evidenceId: `${String(index + 1).padStart(8, "0")}-3333-4333-8333-333333333333`,
            kind: "CLIP"
        }
    ],
    judgment: value
...
export const analysis = (count = 3): AnalysisView => ({
    ...
    candidates: Array.from({ length: count }, (_, index) =>
        candidate(index, index === 1 ? judgment : null)
    )
});
